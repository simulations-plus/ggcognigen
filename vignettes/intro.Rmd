...
author:
  ...
  - name: "for Cognigen, a SimulationsPlus Company"
output: 
  html_document:
    toc: true
    toc_float: true
...
Installation of the `ggcognigen` package can be performed using the source code provided in the compressed .tar.gz file which Cognigen sent you. For instance: 
